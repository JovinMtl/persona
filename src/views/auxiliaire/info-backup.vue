        ...
        <div class="infoContainer">
            ...
            <div class="infoImage">
                <span style="border-radius: 50px;">
                    <!-- <ion-img src="/personaFoto/loader.png"/> -->
                    <img class="imagePosition" style="border-radius: 150px;" src="/personaFoto/profile.png" alt="">
                </span>

                <span class="cicleProfile" style="">
                </span>
